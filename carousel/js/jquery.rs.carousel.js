        ...
        goToPage: function (index, animate, /* INTERNAL */ eventName, /* INTERNAL */ silent) {
            ...
            if (!this.options.disabled && this._isValid(index)) {
                ...
                /*if(index == 0) {
                    ...
                    this._addPrevActions()
                }

                if(!this._isValid(index + 1)) {
                    this._removeNextActions();
                } else {
                    this._addNextActions()
                }*/
